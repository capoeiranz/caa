      ...
      >
        <div
          ...
          className="
            ...
            group-data-[variant=floating]:rounded-none
...
function SidebarSeparator({
  className,
  ...props
}: Omit<React.ComponentProps<typeof Separator>, "className"> & {
  className?: string
}) {
  return (
    <Separator
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        `
          flex min-h-0 flex-1 scrollbar-none flex-col gap-0 overflow-auto
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          `
            flex h-8 shrink-0 items-center rounded-none px-2 text-xs
    ...
    props: mergeProps<"button">(
      {
        className: cn(
          `
            ...
            justify-center rounded-none p-0 text-sidebar-foreground
...
const sidebarMenuButtonVariants = cva(
  `
    ...
    overflow-hidden rounded-none p-2 text-left text-xs ring-sidebar-ring
    ...
    <div
      ...
      className={cn(
        `
          ...
          justify-center rounded-none px-1 text-xs font-medium
    ...
    props: mergeProps<"a">(
      {
        className: cn(
          `
            ...
            rounded-none px-2 text-sidebar-foreground ring-sidebar-ring
            outline-hidden
            group-data-[collapsible=icon]:hidden
            hover:bg-sidebar-accent hover:text-sidebar-accent-foreground
            focus-visible:ring-2
