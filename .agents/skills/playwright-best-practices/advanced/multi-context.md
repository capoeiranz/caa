...
**multi-user collaboration testing** (multiple users interacting simultaneously), see
...
> [third-party.md](third-party.md#oauthsso-mocking). This section focuses on popup window handling
