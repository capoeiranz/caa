...
> verifying backend behavior without browser overhead. **See also**:
> [graphql-testing.md](graphql-testing.md) for GraphQL-specific patterns.
...
test the browser file picker dialog — use `page.setInputFiles()` instead.
