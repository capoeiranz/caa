...
> **For flaky test detection commands, root cause analysis, and fixing strategies**, see
...
> **For comprehensive console error handling** (fail on errors, allowed patterns, fixtures), see
> [console-errors.md](console-errors.md).
...
4. **Check related areas**
   - Network requests: Are API calls completing? (see
