...
- `.agents/scratch/` — sign that a local-markdown issue tracker convention is already in use
...
> `gh issue create`, write a markdown file under `.agents/scratch/`, or follow some other workflow
> you describe. Pick the place you actually track work for this repo.
...
- **Local markdown** — issues live as files under `.agents/scratch/<feature>/` in this repo (good
  for solo projects or repos without a remote)
