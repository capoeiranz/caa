...
description:
  ...
  when user wants to create a PRD from the current context.
---
...
3. Write the PRD using the template below, then publish it to the project issue tracker. Apply the
